...
srun python main.py -g 8 -n 1 -w 10 -b 16 -e 10 --data_dir data/mri.pkl --pin_memory --wandb_project_name test --cfg cfg/sample_mri.yml --model_ckpt_dir ./model_ckpt/$(date +'%Y%m%d_%H%M%S')
