...
srun python main.py -g 8 -n 1 -w 10 -b 8 -e 4 --data_dir data/mmfi.pkl --pin_memory --exp_name mri_da_mmfi_raw --cfg cfg/sample_mmfi_da.yml --version $(date +'%Y%m%d_%H%M%S') --only_load_model --checkpoint_path /home/zpengac/pose/dgmmwave/logs/mri_da/20240701_225653/p4tda-epoch=284-val_loss=15.6399.ckpt
