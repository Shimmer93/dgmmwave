...
srun python main.py -g 8 -n 1 -w 10 -b 128 -e 100 --data_dir data/mmfi.pkl --pin_memory --wandb_project_name test --cfg cfg/sample_p4t.yml --model_ckpt_dir ./model_ckpt/$(date +'%Y%m%d_%H%M%S')
