...
srun python main.py -g 1 -n 1 -w 10 -b 16 -e 1 --data_dir data/milipoint.pkl --pin_memory --wandb_project_name test --cfg cfg/sample.yml --model_ckpt_dir ./model_ckpt/$(date +'%Y%m%d_%H%M%S')
